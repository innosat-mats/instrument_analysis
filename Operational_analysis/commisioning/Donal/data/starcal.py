...
plt.semilogx(ir3cal[:,4]-0.4,y3)
csh=heights(ir4[n],4)
y4=csh(range(ir4cal.shape[0]))
plt.semilogx(ir4cal[:,4]-0.8,y4)
plt.semilogx(sasktran[50:,3]/3.19e9,sasktran[50:,0])
plt.semilogx(sasktran[50:,4]/3.21e9,sasktran[50:,0])
plt.gca().axis('auto')
plt.autoscale()
plt.ylabel('Altitude(km)')
plt.xlabel('Intensity (Witt)')
plt.legend(('IR3','IR4', 'Sask3','Sask4'))

#%%
plt.figure(figsize=[6,4])
csh=heights(ir1[n],4)
y3=csh(range(ir1cal.shape[0]))
plt.semilogx(ir1cal[:,4],y3)
csh=heights(ir2[n],4)
y4=csh(range(ir2cal.shape[0]))
plt.semilogx(ir2cal[:,4],y4)
plt.semilogx(sasktran[50:,1]/3.58e9,sasktran[50:,0])
plt.semilogx(sasktran[50:,2]/8.16e9,sasktran[50:,0])
plt.gca().axis('auto')
plt.autoscale()
plt.ylabel('Altitude(km)')
plt.xlabel('Intensity (Witt)')
plt.legend(('IR1','IR2', 'Sask1','Sask2'))

# %%
sasktran=np.loadtxt('/Users/donal/Downloads/limbViewing-IR1-4-RayleighProfiles_20230109-001003.txt',skiprows=1)

plt.plot(sasktran[50:,2]/3e9,sasktran[50:,0])
