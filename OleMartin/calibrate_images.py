...
stop_time = DT.datetime(2023,1,30,18,5,0)
...
# %%
#for i in range(len(CCDitems)):
image_lsb, image_bias_sub, image_desmeared, image_dark_sub, image_calib_nonflipped, image_calibrated, errors = L1_calibrate(CCDitems[0],instrument)
