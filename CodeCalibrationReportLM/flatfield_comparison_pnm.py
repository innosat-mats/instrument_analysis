...
# =============================================================================
    ...
    if when=='May2020':
        ...
        dir2='/Users/lindamegner/MATS/retrieval/Calibration/FM_calibration_at_Omnisys/ScreenCalibration/'
        if channel=='IR3':
            filename2=dir2+'rawoutput'+'12021'+'.pnm' 
            dfilename2=dir2+'rawoutput'+'14198'+'.pnm'      
        elif channel=='UV2':
            filename2=dir2+'rawoutput'+'985'+'.pnm' #Jörg
            dfilename2=dir2+'rawoutput'+'3243'+'.pnm'     
        else:
            print('Error no',channel,' channel for ',when)
    ...
    plot_CCDimage(img1, fig, ax[0],title='OHB April 2021 B-D')
    ...
    fig.savefig('Limb_flatfield_diff_April2021_to_'+when+ channel+'.jpg')