...
def findpattern(lena,template):
    ...
    if True:
        ...
        fig.savefig(output_imagedir+'Limb_image_quality_cooltest_example.jpg') 
...
piclist=[cooltest_22C, cooltest_14C, cooltest_11C, cooltest_05C, CCDitem['IMAGE']]
namelist=['Jan 2020 22 C','Jan 2020 13C','Jan 2020 11C','Jan 2020 5 C', 'Feb 2021' ]
...
picdictlistselect=[picdictlist[i] for i in [0, 1,3]]
...
fig2.savefig(output_imagedir+'Limb_image_quality_cooltest'+channel+'.jpg')    
fig3.savefig(output_imagedir+'Limb_image_resolution_cooltest_'+channel+'.jpg')
