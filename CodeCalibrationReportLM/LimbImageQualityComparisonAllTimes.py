...
namelist=['Marsh 2018','April 2018','May 2019 ', 'Sept 2019', 'Jan 2020 22 C','Jan 2020 14C','Jan 2020 11C','Jan 2020 5 C', 'Feb 2021' ]
rotated=[False, True, True, True, True, True, True, True, False]
picdictlist=[]
...
picdictlistselect=[picdictlist[i] for i in [0, 1,2, 4,8]]
...
fig2.savefig(output_imagedir+'image_quality_alltime'+channel+'.jpg')    
fig3.savefig(output_imagedir+'image_resolution_alltime'+channel+'.jpg')
